...
#
# v7.1.1-Final-arm64 — Stable release: CPU monitor + AI chat (OpenAI & OpenRouter only).
#
...
EXPECTED_HASH="ef6f82ca4c71693938480a9c94dd7a9a1aaa44985fffba4cdeb2b748ed6ed405"
...
let CURRENT_VERSION = "v7.1.1-Final-arm64"
