...
EXPECTED_HASH="aa2eb3d2ca081809ff586aacd33d2aecf116c3faf92fd334bffa6c5ce18b35d6"
...
let CURRENT_VERSION = "v8.2.1-Beta-arm64"
...
enum AppTab: String, CaseIterable, Identifiable {
    ...
    case chat = "Chat"
    var id: String { rawValue }
    static let popoverTabs: [AppTab] = [.monitor, .chat]
    static let windowTabs: [AppTab] = [.monitor, .chat]
}
...
<dict>
    ...
    <key>CFBundleShortVersionString</key><string>8.2.1-Beta-arm64</string>
