...
#
# v8.3.5-Final-arm64 — Stable release: CPU monitor + AI chat (OpenAI & OpenRouter only).
#
...
EXPECTED_HASH="86ec5700bcf931d54d663649b4bde1815caf7700948a8e594440bda9e0250644"
...
let CURRENT_VERSION = "v8.3.5-Final-arm64"
...
struct HowItWorksView: View {
    ...
    private var monitorFlowchart: some View {
        FlowchartPanel(
            ...
            caption: "How menu bar stats stay current while rNitro is running."
        ) {
                VStack(alignment: .leading, spacing: 0) {
                    FlowchartNode(
                    ...
                    FlowchartNode(
                        title: "Update UI",
                        detail: "Monitor tab, menubar popover, and detail sheets refresh on the main thread.",
                        accent: .nGreen
                    )
