...
**Beta (v8.4.0 Beta):**
```bash
curl -fsSL https://getrnitro.netlify.app/rNitro-v8.4.0-Beta-arm64.sh -o /tmp/rnitro-install.sh && bash /tmp/rnitro-install.sh
```
<!-- @end:readme-curl -->
...
| Format | File |
|--------|------|
| **App ZIP** | [rNitro-v8.4.0-Beta-arm64.zip](https://github.com/ilikemacos/rNitro/releases/download/v8.4.0-Beta/rNitro-v8.4.0-Beta-arm64.zip) |
| **PKG** | [rNitro-v8.4.0-Beta-arm64.pkg](https://github.com/ilikemacos/rNitro/releases/download/v8.4.0-Beta/rNitro-v8.4.0-Beta-arm64.pkg) |
| **DMG** | [rNitro-v8.4.0-Beta-arm64.dmg](https://github.com/ilikemacos/rNitro/releases/download/v8.4.0-Beta/rNitro-v8.4.0-Beta-arm64.dmg) |
