...
EXPECTED_HASH="34f4464b87f4b4a0ee0a75f99d60c58df939b377b32e32ee5ed201f1826918e6"
...
let CURRENT_VERSION = "v8.3.1-Beta-arm64"
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            VStack(alignment: .leading, spacing: 6) {
                Text("AI Providers").font(rNitroFont(.title, metrics: metrics, weight: .semibold))
            ...
            AIProviderPicker(chat: chat).padding(.horizontal, metrics.hPad).padding(.bottom, 8)
            MinimalDivider().padding(.horizontal, metrics.hPad)
            ScrollView {
...
struct AIChatView: View {
    ...
    private func openSettingsTab() {
        NotificationCenter.default.post(name: .rNitroOpenMainWindow, object: nil, userInfo: ["tab": AppTab.settings.rawValue])
    }
...
final class HowItWorksModel: ObservableObject {
    @Published var stableId = "v8.2.9-Final-arm64"
...
struct HowItWorksView: View {
    ...
    private var flowRows: [[AnyView]] {
        [
            ...
            [AnyView(Text("In-app guide")), AnyView(Text("Open this How it works tab anytime; Settings tab holds API keys and provider status."))],
