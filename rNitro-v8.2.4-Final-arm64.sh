...
#
# v8.2.4-Final-arm64 — Stable release: CPU monitor + AI chat (OpenAI & OpenRouter only).
#
...
EXPECTED_HASH="1feff52849f522ee91c481c52cfb10734331259d0cc81be468cee6732bf72112"
...
let CURRENT_VERSION = "v8.2.4-Final-arm64"
...
<dict>
    ...
    <key>CFBundleShortVersionString</key><string>8.2.4-Final-arm64</string>
