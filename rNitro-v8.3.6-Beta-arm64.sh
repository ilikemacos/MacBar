...
EXPECTED_HASH="0f95d77b05a583218e8aa61d427d614af675e28b4d4e000e7626bff9c92edf59"
...
let CURRENT_VERSION = "v8.3.6-Beta-arm64"
...
enum UpdateInstaller {
    ...
    private static func replaceApp(stagedApp: URL, destination: URL) -> ReplaceResult {
        ...
        let parentPath = shellQuote(parent.path)
