...
#
# v8.2.5-Final-arm64 — Stable release: CPU monitor + AI chat (OpenAI & OpenRouter only).
#
...
EXPECTED_HASH="89af161a085fa8dbd96184f8da085645ffff61ae5331ba432b1a7602a396ac33"
...
let CURRENT_VERSION = "v8.2.5-Final-arm64"
    ...
    static func checkOnLaunch() {
        ...
        PinnedSession.shared.dataTask(with: req) { data, _, error in
            ...
            DispatchQueue.main.async {
                ...
                alert.informativeText = "You're running \(CURRENT_VERSION). A newer build is available: \(remote). Opening getrnitro.netlify.app so you can update."
...
<dict>
    ...
    <key>CFBundleShortVersionString</key><string>8.2.5-Final-arm64</string>
