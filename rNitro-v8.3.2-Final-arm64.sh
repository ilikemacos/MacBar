...
#
# v8.3.2-Final-arm64 — Stable release: CPU monitor + AI chat (OpenAI & OpenRouter only).
#
...
EXPECTED_HASH="f5727c04ea7875fa104ee436ef3325ed9e9203834769aa6cc35a5c349e659f08"
...
let CURRENT_VERSION = "v8.3.2-Final-arm64"
...
<dict>
    ...
    <key>CFBundleVersion</key><string>8.3.2-Final-arm64</string>
    <key>CFBundleShortVersionString</key><string>8.3.2-Final-arm64</string>
