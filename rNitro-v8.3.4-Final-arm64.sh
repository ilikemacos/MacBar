...
#
# v8.3.4-Final-arm64 — Stable release: CPU monitor + AI chat (OpenAI & OpenRouter only).
#
...
EXPECTED_HASH="860a689c14745d06f6e4479bb4f44eae0c381c0a11c4073ffbe7a8f7a4c02d0c"
...
let CURRENT_VERSION = "v8.3.4-Final-arm64"
