...
#
# v8.2.6-Final-arm64 — Stable release: CPU monitor + AI chat (OpenAI & OpenRouter only).
#
...
EXPECTED_HASH="5792296930140ebc733b9ffe6c08e990dcc1841839e81b58e9be4ead16946e8f"
...
let CURRENT_VERSION = "v8.2.6-Final-arm64"
...
<dict>
    ...
    <key>CFBundleShortVersionString</key><string>8.2.6-Final-arm64</string>
